...
Game.prototype.addPlayer = function(playerData) {
  ...
  // OK now that total image key arrays have been prepared, create the player 
  var player = {name: playerData.playerName, isHost: playerData.isHost, role: playerData.role, meansCards: [], evidenceCards: [] };
